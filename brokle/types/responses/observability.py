...
class ObservabilityObservationResponse(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Observation metadata")
    ...
    completion_start_time: Optional[datetime] = Field(default=None, description="Completion start time")
    internal_model: Optional[str] = Field(default=None, description="Internal model")
    internal_model_parameters: Optional[Dict[str, Any]] = Field(default=None, description="Internal model parameters")
    quality_scores: Optional[List['ObservabilityQualityScoreResponse']] = Field(default=None, description="Quality scores")
    created_at: datetime = Field(description="Creation timestamp")
    updated_at: datetime = Field(description="Update timestamp")
...
class EvaluationResponse(BaseModel):
    ...
    overall_score: Optional[float] = Field(default=None, description="Overall evaluation score")
    passed: bool = Field(description="Whether evaluation passed")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Evaluation metadata")
    created_at: datetime = Field(description="Creation timestamp")
