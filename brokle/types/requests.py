...
class BaseRequest(BaseModel):
    ...
    cache_strategy: Optional[str] = Field(
        default=None,
        description="Cache strategy: 'semantic', 'exact', 'disabled'"
    )
...
class CompletionRequest(BaseRequest):
    ...
    logprobs: Optional[int] = Field(default=None, description="Number of log probabilities")
...
class ChatCompletionRequest(BaseRequest):
    ...
    # Function calling
    functions: Optional[List[Dict[str, Any]]] = Field(default=None, description="Function definitions")
    function_call: Optional[Union[str, Dict[str, str]]] = Field(default=None, description="Function call")
    
    # Tool calling (newer OpenAI API)
    tools: Optional[List[Dict[str, Any]]] = Field(default=None, description="Tool definitions")
    tool_choice: Optional[Union[str, Dict[str, Any]]] = Field(default=None, description="Tool choice")
...
class AnalyticsRequest(BaseModel):
    ...
    metrics: Optional[List[str]] = Field(default=None, description="Metrics to retrieve")
...
class EvaluationRequest(BaseModel):
    ...
    response_id: Optional[str] = Field(default=None, description="Response ID to evaluate")
    ...
    feedback_value: Optional[Union[str, float, bool]] = Field(default=None, description="Feedback value")
...
class CacheGetRequest(BaseModel):
    ...
    similarity_threshold: Optional[float] = Field(default=0.8, description="Similarity threshold")
...
class CostCalculationRequest(BaseModel):
    ...
    additional_costs: Optional[Dict[str, float]] = Field(default=None, description="Additional costs")
...
class BudgetRequest(BaseModel):
    ...
    start_date: Optional[str] = Field(default=None, description="Budget start date (ISO format)")
    end_date: Optional[str] = Field(default=None, description="Budget end date (ISO format)")
...
class MLRoutingRequest(BaseModel):
    ...
    input_text: Optional[str] = Field(default=None, description="Input text for analysis")
    routing_strategy: Optional[str] = Field(default="balanced", description="Routing strategy")
    constraints: Optional[Dict[str, Any]] = Field(default=None, description="Routing constraints")
    historical_data: Optional[Dict[str, Any]] = Field(default=None, description="Historical performance data")
...
class FeatureFlagRequest(BaseModel):
    ...
    organization_id: str = Field(description="Organization ID")
    feature_name: Optional[str] = Field(default=None, description="Specific feature name")
...
class UsageRecordingRequest(BaseModel):
    ...
    timestamp: Optional[str] = Field(default=None, description="Request timestamp (ISO format)")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Additional metadata")
...
class NotificationRequest(BaseModel):
    ...
    template_data: Optional[Dict[str, Any]] = Field(default=None, description="Template data")
