...
class QuotaExceededError(BrokleError):
    ...
    def __init__(self, message: str, quota_info: Optional[Dict[str, Any]] = None, **kwargs):
        super().__init__(
            message,
            status_code=kwargs.get('status_code', 429),
...
class ProviderError(BrokleError):
    ...
    def __init__(self, message: str, provider_details: Optional[Dict[str, Any]] = None, **kwargs):
        super().__init__(
            message,
...
class CacheError(BrokleError):
    ...
    def __init__(self, message: str, cache_details: Optional[Dict[str, Any]] = None, **kwargs):
        super().__init__(
            message,
...
class EvaluationError(BrokleError):
    ...
    def __init__(self, message: str, evaluation_details: Optional[Dict[str, Any]] = None, **kwargs):
        super().__init__(
            message,
            status_code=kwargs.get('status_code', 500),
